  ...
  <div class="row">
    ...
    ?>
	  ...
	  <div class="form-group">
		...
		echo form_input(['name' => 'nearest_town_distance', 'id' => 'nearest_town_distance',  'value' =>  $nearest_town_distance, 'class' => 'form-control']);
        ?>
      </div>
	  ...
	  <div class="form-group">
		...
		echo form_input(['name' => 'nearest_depot_distance', 'id' => 'nearest_depot_distance',  'value' =>  $nearest_depot_distance, 'class' => 'form-control']);
        ?>
      </div>
